...
| `compass-line-guard` | Stop | Blocks stop when a working turn's reply doesn't OPEN with a plain-English "Mission / this step / why" line — advisory versions of this get compressed out under context pressure, so this one enforces it. Chat-only turns are exempt |
